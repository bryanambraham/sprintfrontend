...
interface WhyChooseHeroProps {
  className?: string
}

export function WhyChooseHero({ className = "" }: WhyChooseHeroProps) {
  return (
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="space-y-6 py-3 text-white">
            ...
            <div className="flex items-start gap-2">
              ...
              <div>
                ...
                <Link href="#" className="underline font-bold hover:text-gray-100">
          ...
          <div className="relative mt-12 flex justify-center items-center">
            ...
            <div className="absolute -top-16">
              ...
              <Image
                      src="/arrow-down-animated.gif"
                      alt="Arrow pointing to WhatsApp button"
                      width={50}
                      height={50}
